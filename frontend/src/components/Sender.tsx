                ...
                <div className="flex items-center justify-center min-h-[80vh]">
                    <div className="text-center max-w-md">
                        ...
                        <p className="text-slate-300 mb-8">
                            Click the button below to start your video call and wait for someone to join.
                        </p>
                        <button
                            onClick={startSendingVideo}
                            className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 hover:scale-105"
                        >
                            Start Video Call
                        </button>
                    </div>
